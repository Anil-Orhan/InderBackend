    ...
    public class ProjectDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                     new Category { Id = 1, Name = "Başkandan Yazılar",CreateDate=DateTime.Now,ModifiedDate=DateTime.Now,Status=true },
                     new Category { Id = 2, Name = "Genel Sekreterden Yazılar",CreateDate=DateTime.Now,ModifiedDate=DateTime.Now,Status=true },
                     new Category { Id = 3, Name = "TV Programı ve Röportajlar",CreateDate=DateTime.Now,ModifiedDate=DateTime.Now,Status=true },
                     new Category { Id = 4, Name = "Etkinlikler",CreateDate=DateTime.Now,ModifiedDate=DateTime.Now,Status=true },
                     new Category { Id = 5, Name = "Genç İnder",CreateDate=DateTime.Now,ModifiedDate=DateTime.Now,Status=true });
        }
